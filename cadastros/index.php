...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    do {
        $c_senha = $_POST['senha'];
        if ($c_senha == 'mudas@2025')
            header('location: /mudas/cadastros/menu.php');
        else {
                ...
                <div class="row mb-2">
                    ...
                    <div class="panel default class" class="row col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center">
                        <div class="panel-heading">
                            <img class="rounded mx-auto d-block" class="img-responsive" src="\parque\imagens\prefeitura.png" class="img-fluid" style="height :150px" style="width:100px">
                        </div>
                    </div>
                </div>
            </form>
